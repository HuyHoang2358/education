    ...
    <div class="h-screen flex flex-col justify-between">
        ...
        <div class="px-60 h-[750px] flex flex-col items-center">
            <div class="text-center flex flex-col items-center">
                ...
                <p class="text-[#0B8493] font-bold text-lg pt-4">Bước 2/4</p>
                <h3 class="text-3xl font-semibold py-2">Tuyệt vời! Vai trò hiện tại của bạn là gì?</h3>
            </div>
            <div class="text-lg font-semibold grid grid-cols-3 gap-6 mt-10">
                <div class="flex items-center gap-4 bg-white rounded-2xl border-gray-300 border-2 w-[304px] h-20 px-4 group hover:border-[#02CFD8] duration-500 ease-in-out">
                    ...
                    <p class="group-hover:text-[#0B8493] duration-500 ease-in-out">Học Sinh cấp 1</p>
                </div>
                <div class="flex items-center gap-4 bg-white rounded-2xl border-gray-300 border-2 w-[304px] h-20 px-4 group hover:border-[#02CFD8] duration-500 ease-in-out">
                    ...
                    <p class="group-hover:text-[#0B8493] duration-500 ease-in-out">Học Sinh cấp 2</p>
                </div>
                <div class="flex items-center gap-4 bg-white rounded-2xl border-gray-300 border-2 w-[304px] h-20 px-4 group hover:border-[#02CFD8] duration-500 ease-in-out">
                    ...
                    <p class="group-hover:text-[#0B8493] duration-500 ease-in-out">Học Sinh cấp 3</p>
                </div>
                <div class="flex items-center gap-4 bg-white rounded-2xl border-gray-300 border-2 w-[304px] h-20 px-4 group hover:border-[#02CFD8] duration-500 ease-in-out">
                    ...
                    <p class="group-hover:text-[#0B8493] duration-500 ease-in-out">Sinh viên</p>
                </div>
                <div class="flex items-center gap-4 bg-white rounded-2xl border-gray-300 border-2 w-[304px] h-20 px-4 group hover:border-[#02CFD8] duration-500 ease-in-out">
                    ...
                    <p class="group-hover:text-[#0B8493] duration-500 ease-in-out">Giáo Viên</p>
                </div>
                <div class="flex items-center gap-4 bg-white rounded-2xl border-gray-300 border-2 w-[304px] h-20 px-4 group hover:border-[#02CFD8] duration-500 ease-in-out">
                    ...
                    <p class="group-hover:text-[#0B8493] duration-500 ease-in-out">Người đi làm</p>
                </div>
            </div>
        </div>

        <div class="flex justify-center bg-white py-5 gap-5">
            <a href="khao-sat-first">
                <button
